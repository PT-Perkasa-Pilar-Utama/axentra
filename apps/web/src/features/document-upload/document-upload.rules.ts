...
/**
 * Hanya kegagalan transien (jaringan / 5xx / error generik) yang ditawarkan
 * retry. Duplikat dan tipe tidak didukung tidak berubah hasilnya bila file
 * yang sama diunggah ulang, jadi pengguna diarahkan memilih file lain.
 */
